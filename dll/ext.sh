...
wget -q -O /usr/bin/add-host "https://raw.githubusercontent.com/scvpn/scriptvps/main/ssh/add-host.sh" && chmod +x /usr/bin/add-host
wget -q -O /usr/bin/about "https://raw.githubusercontent.com/scvpn/scriptvps/main/ssh/about.sh" && chmod +x /usr/bin/about
